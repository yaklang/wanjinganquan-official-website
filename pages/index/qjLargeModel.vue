  ...
  <div class="mt-[86px]">
    ...
    <div class="wjaq-container mx-auto overflow-hidden">
      ...
      <div class="mt-[235px]">
        ...
        <div class="flex justify-between mb-[100px]">
          <div class="w-[28%]">
            ...
            <div class="color-[#868686] mb-[122px]">千机是一款使用RLHF优化并利用知识图谱进行领域知识增强的垂直领域大语言模型应用。</div>
            <div class="text-center">
              <NuxtImg src="/Images/qj_lyzszq.png" class="w-[280px]" />
            </div>
          </div>
          <div class="w-[28%]">
            <div class="font-bold-600 mb-[25px] text-center text-[25px]">指令优化与丰富</div>
            <div class="color-[#868686] mb-[122px]">通过图谱背景知识，千机能对用户原始指令进行精准整理和优化，使指令描述更准确、更丰富。</div>
            <div class="text-center">
              <NuxtImg src="/Images/qj_zlyhyff.png" class="w-[250px]" />
            </div>
          </div>
          <div class="w-[28%]">
            <div class="font-bold-600 mb-[25px] text-center text-[25px]">精准响应与约束</div>
            <div class="color-[#868686] mb-[122px]">千机不仅生成回答，还利用背景知识约束生成的文本，缩小计算响应与背景知识的偏离度，确保回答准确无误。</div>
            <div class="text-center">
      ...
      <div class="qj_cont bg-center bg-contain bg-no-repeat">
          ...
          <div class="flex justify-between items-center px-[10px]">
            <div data-aos="fade-right" class="w-[520px]">
              ...
              <div class="mb-[15px]">
                ...
                <span class="color-[#646363]">快速生成大量内容差异的社工诱饵，帮助企业攻防演习过程中考察员工意识。</span>
              </div>
              <div class="mb-[15px]">
                <span class="font-bold-600">WEBSHELL研判 — </span>
                <span class="color-[#646363]">能基于代码逻辑及其最终实现功能，识别市面上绝大多数的“免杀”WebShell，供安全专家决策参考。</span>
              </div>
            </div>
        ...
        <!-- POC代码生成 -->
        <div class="mt-[100px]">
          <div class="relative py-[15px] px-[40px] mb-[50px] mx-auto w-[350px]">
            <div class="text-[32px] text-center font-bold-600">
              POC代码生成
            </div>
          </div>
          <NuxtImg src="/Images/qj_rectangle.png" class="w-[1200px]" />
        </div>
        <!-- 大模型赋能产业发展 -->
        <div class="mb-[100px]">
          ...
          <div class="relative">
            <div data-aos="fade-down" class="w-[260px] mx-auto">
              ...
              <div class="text-[16px] color-[#646363]">千机具备原子操作级代码分析能力，对各类未知数据样本都具备一定的研判效果。</div>
            </div>
            <div class="flex justify-between items-center mt-[25px] mb-[50px]">
              <div data-aos="fade-left">
                <div class="w-[260px] mb-[75px]">
                  <div class="text-[18px] mb-[10px] font-bold-600">提高数据运营效率</div>
                  <div class="text-[16px] color-[#646363]">通过大模型对多源异构的安全运营数据进行语义归一化处理，实现数据的上下文标准统一流转。</div>
                </div>
                <div class="w-[260px]">
                  <div class="text-[18px] mb-[10px] font-bold-600">降低人力资源成本</div>
                  <div class="text-[16px] color-[#646363]">利用领域大模型的专业知识处理能力充当AI教练，降低从业人员的培训成本和运营成本。</div>
                </div>
              </div>
              <div>
                <NuxtImg src="/Images/qj_cyfn.png" class="w-[400px]" />
              </div>
              <div data-aos="fade-right">
                <div class="w-[260px] mb-[75px]">
                  <div class="text-[18px] mb-[10px] font-bold-600">融合安全防护设备</div>
                  <div class="text-[16px] color-[#646363]">结合思维链技术，千机能够以极低成本将企业各类安全防护设备资源进行融合，使其成为一个完整的安全运营系统。</div>
                </div>
                <div class="w-[260px]">
                  <div class="text-[18px] mb-[10px] font-bold-600">沉淀模型优化场景</div>
                  <div class="text-[16px] color-[#646363]">经过大量真实业务场景的实践，千机能够根据场景实际需求通过微调与专业知识补充，不断完善自身功能。</div>
                </div>
              </div>
            </div>
            <div data-aos="fade-up" class="w-[260px] mx-auto">
              <div class="text-[18px] mb-[10px] font-bold-600">提高应急响应效率</div>
              <div class="text-[16px] color-[#646363]">利用大模型构建应急响应标准流程，并在具体事件处置过程中，使用大模型进行辅助决策。</div>
            </div>
          </div>
        </div>
      </div>
...
.qj_cont {
  background-image: url("/Images/qj_bg.png");
}
</style>
